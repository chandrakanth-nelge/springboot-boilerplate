...
import com.chan.nel.springboot.boilerplate.dto.validator.ExistRoleValidator;
...
public class RoleController {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successfully retrieved the list of roles with respective permissions", examples = @Example(value = @ExampleProperty(value = "", mediaType = "application/json"))),
	...
	public Response<RoleDto> createRole(
			@ApiParam(value = "role object to store in database table", required = true) @RequestBody @Validated CreateRoleDto createRoleDto) {
	...
	public Response<RoleDto> updateRole(
			@ApiParam(value = "Update role object", required = true) @RequestBody @Validated UpdateRoleDto updateRoleDto) {
	...
	public Response deleteRole(
			@ApiParam(value = "Role UUID from which role object will delete from database table", example = "36ed1611"
					+ "-5236-42a3-83ec-d408b45e3c19", required = true) @PathVariable(value = "uuid") @Exist(message = "1009", constraintValidator = ExistRoleValidator.class) UUID uuid) {
